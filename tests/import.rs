...
#[rstest]
fn writes_actual_only_settings_entries_to_import_lua(env: Env) {
...
#[rstest]
fn writes_both_settings_and_mcp_servers_drift(env: Env) {
    env.write_entry_lua("return { settings = { model = 'opus' }, mcpServers = { context7 = {} } }");
    env.write_settings(r#"{"model":"opus","extraField":true}"#);
    env.write_claude_json(r#"{"mcpServers":{"context7":{},"foo":{"command":"bar"}}}"#);
...
#[rstest]
fn writes_header_only_return_when_there_is_no_drift(env: Env) {
    env.write_entry_lua("return { settings = { model = 'opus' } }");
...
#[rstest]
fn overwrites_existing_import_lua_and_drops_entries_no_longer_drift(env: Env) {
    env.write_entry_lua("return { settings = { model = 'opus' } }");
